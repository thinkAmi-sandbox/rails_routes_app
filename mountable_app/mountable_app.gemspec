require_relative "lib/mountable_app/version"

Gem::Specification.new do |spec|
  spec.name        = "mountable_app"
  spec.version     = MountableApp::VERSION
  spec.authors     = ["thinkAmi"]
  spec.email       = ["dev.thinkami+git@gmail.com"]
  spec.homepage    = "https://thinkami.hatenablog.com/"
  spec.summary     = "Summary of MountableApp."
  spec.description = "Description of MountableApp."
